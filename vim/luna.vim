...
let s:N1 = [ '#ffffff' , '#4527A0' , 231  , 36 ]
let s:N2 = [ '#ffffff' , '#003f3f' , 231 , 29 ]
let s:N3 = [ '#ffffff' , '#311B92' , 231  , 23 ]
...
let s:I1 = [ '#ffffff' , '#0D47A1' , 231 , 106 ]
let s:I2 = [ '#ffffff' , '#003f3f' , 231 , 29  ]
let s:I3 = [ '#ffffff' , '#2962FF' , 231 , 23  ]
...
let g:airline#themes#luna#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#0277BD' , 255     , 52      , ''     ] ,
      \ }
...
let s:V1 = [ '#ffff9a' , '#D84315' , 222 , 208 ]
let s:V2 = [ '#ffffff' , '#003f3f' , 231 , 29 ]
let s:V3 = [ '#ffffff' , '#BF360C' , 231  , 23  ]
...
let g:airline#themes#luna#palette.tabline = {
      ...
      \ 'airline_tabsel':  ['#ffffff', '#311B92',  231, 36, ''],
